            ...
            for table in tables:
                ...
                for fk in fk_rows:
                    ...
                    if referenced_table not in relationships:
                        relationships[referenced_table] = set()

                    # Keep runtime relationship graph bidirectional so parent tables
                    # can discover child/detail tables during chat expansion.
                    relationships[table].add(referenced_table)
                    relationships[referenced_table].add(table)
